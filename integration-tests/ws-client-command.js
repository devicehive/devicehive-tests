...
describe('WebSocket API Client Command', function () {
    ...
    describe('#command/subscribe', function () {
        ...
        it('should subscribe to device commands, access key authorization', function (done) { // TODO: Won't get subscribed notif.
            runTest(clientAK, done);
        });
    });
    ...
    describe('#command/update', function () {
        ...
        it.only('should update existing command, access key auth', function (done) {
            runTest(clientAK, done);
        });
    });
